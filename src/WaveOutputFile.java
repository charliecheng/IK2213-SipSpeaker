...
public class WaveOutputFile extends RandomAccessFile{
  ...
  public WaveOutputFile(File file,AudioFormat format,byte[] data)throws FileNotFoundException,IOException{
    super(file,"rw");
    write(getHeader(format));
    write(data);
  }

  public WaveOutputFile(String file,AudioFormat format,byte[] data)throws FileNotFoundException,IOException{
    super(file,"rw");
    write(getHeader(format));
    write(data);
  }
